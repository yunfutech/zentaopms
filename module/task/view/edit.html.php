            ...
            <table class='table table-form'>
              ...
              <tr>
                ...
                <td><?php echo $task->consumed . ' ';
                    common::printIcon('task', 'recordEstimate', "taskID=$task->id", $task, 'list', '', '', 'record-estimate-toggle btn-link', true); ?></td>
              </tr>
              <tr>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content with-padding" id='taskTeamEditor'>
          <table class='table table-form'>
            ...
            <tfoot>
              <tr>
                <td colspan='3' class='text-center form-actions'><?php echo html::a('javascript:void(0)', $lang->confirm, '', "class='btn btn-primary btn-wide' data-dismiss='modal'"); ?></td>
              </tr>
            </tfoot>
          </table>
        </div>
