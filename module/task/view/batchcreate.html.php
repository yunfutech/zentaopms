...
<div id="mainContent" class="main-content fade">
  <div class="main-header clearfix">
    ...
    <div class="pull-right text-danger" style="padding: 6px;margin-right: 30px;">
      ...
      <span>注意: 默认截止日期在<?php echo $config->task->deadlinePoint?>点之后为明天</span>
    </div>
  </div>
  <?php
  $visibleFields  = array();
      ...
      <table class="table table-form table-fixed" id="tableBody">
        <thead>
          <tr>
            ...
            <th class='<?php echo zget($visibleFields, 'story', ' hidden') . zget($requiredFields, 'story', '', ' required'); echo $hiddenStory;?>'><?php echo $lang->task->story;?></th>
            <?php endif;?>
            <th class='w-300px c-name required has-btn'><?php echo $lang->task->name;?></span></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td <?php echo zget($visibleFields, 'deadline', "class='hidden'")?>><?php echo html::input("deadline[$i]", $defaultDeadline, "class='form-control text-center form-date'");?></td>
