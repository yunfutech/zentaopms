...
<style>
    ...
    .gantt-fullscreen #footer {
        display: none !important;
    }

    .gantt-fullscreen #mainContent {
        position: fixed;
        top: 0;
        right: 0;
        bottom: 0;
        ...
        switch (node.value) {
            ...
            case "week":
                ...
                gantt.config.scales = [{
                    unit: 'week',
                    step: 1,
                    format: "<?php echo $lang->project->gantt->zooming['week']; ?> #%W"
                }, {
                    unit: "day",
                    step: 1,
                    date: "%D"
            ...
            case "month":
                ...
                gantt.config.scales = [{
                    ...
                    unit: "week",
                    step: 1,
                    date: "<?php echo $lang->project->gantt->zooming['week']; ?> #%W"
                }];
                break;
        }
        gantt.render();
