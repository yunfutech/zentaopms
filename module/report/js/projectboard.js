function changeParams (obj) {
    ...
    var orderBy = $('#conditions').find('#orderBy').val();
    if(begin.indexOf('-') != -1)
    {
    ...
    var link = createLink('report', 'projectboard', 'begin=' + begin + '&end=' + end + '&projectType=' + projectType + '&status=' + status + '&orderBy=' + orderBy);
    location.href = link;
}
