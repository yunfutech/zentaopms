      ...
      <table class="table table-form">
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo html::input('code', '', "class='form-control input-product-code' required"); ?></td>
            <td></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php echo html::select('director', $poUsers, '', "class='form-control chosen'"); ?></td>
            <td></td>
          </tr>
          <tr>
            <th><?php echo $lang->product->counselor; ?></th>
            <td><?php echo html::select('counselor', $poUsers, '', "class='form-control chosen'"); ?></td>
            <td></td>
          </tr>
          <tr>
          ...
          <tr id='whitelistBox'>
            ...
            <td colspan='2'><?php echo html::checkbox('whitelist', $groups, '1,4,8', '', 'inline'); ?></td>
          </tr>
          <tr>
