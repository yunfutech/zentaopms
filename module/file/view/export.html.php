...
<style>
  ...
  #customFields .panel:before,
  #customFields .panel:after {
    content: ' ';
    display: block;
    width: 0;
    height: 0;
...
<script>
  ...
  function setTemplate(templateID) {
    ...
    $('#exportFields option').each(function() {
      optionHtml += $(this).removeAttr('selected').prop('outerHTML')
    });
