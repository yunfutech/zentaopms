      ...
      <tbody>
        <?php foreach ($tasks as $key => $task) : ?>
          <tr class='text-center'>
            ...
            <td>
              <div class='progress-pie' title="<?php echo $task->progress ?>%" data-value='<?php echo $task->progress; ?>'></div>
            </td>
          </tr>
          <?php if (!empty($task->children)) : ?>
            ...
            <?php foreach ($task->children as $key => $child) : ?>
              ...
              <tr class='text-center<?php echo $class; ?> parent-<?php echo $child->parent; ?>'>
                ...
                <td>
                  <div class='progress-pie' title="<?php echo $child->progress ?>%" data-value='<?php echo $child->progress; ?>'></div>
                </td>
              </tr>
              <?php $i++; ?>
            <?php endforeach; ?>
