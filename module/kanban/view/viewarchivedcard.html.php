...
<style>
  ...
  #archivedCards .panel .panel-body {
    overflow: auto;
    padding: 10px;
  }

  #archivedCards .kanban-item {
    border: 1px solid #ddd;
    border-radius: 4px;
    padding: 5px;
  }

  #archivedCards .kanban-item>.title {
    display: block;
    max-height: 38px;
    overflow: hidden;
    color: inherit;
  ...
  #archivedCards .kanban-item>.title:hover {
    color: #2272eb
  }

  #archivedCards .kanban-item>.info {
    margin-top: 5px;
    position: relative;
  }

  #archivedCards .kanban-item>.info>.pri {
    height: 14px;
    border-width: 1px;
    font-size: 12px;
    line-height: 12px;
  ...
  #archivedCards .kanban-item>.info>.time {
    margin-left: 10px;
    font-size: 12px
  }

  #archivedCards .kanban-item>.info>.user {
    position: absolute;
    right: 0;
    top: 0
  }

  #archivedCards .card-actions {
    position: relative;
    padding: 15px 10px;
    padding-top: 0px;
  }

  #archivedCards .card-actions>.btn {
    display: block;
  }

  [lang^='en'] #archivedCards .card-actions>.btn {
    width: 55px;
  }

  #archivedCards .card-actions>.btn+.btn {
    margin-top: 10px;
  }

  #archivedCards .info>.time {
    background-color: rgba(0, 0, 0, 0.15);
  }

  #archivedCards .info>.users {
    padding-right: 10px;
  }

  #archivedCards .info>.users>span {
  ...
  #archivedCards .info>.users>span:before {
    left: -4px;
    content: '';
    display: block;
    position: absolute;
  ...
  #archivedCards .info>.users>span:after {
    right: -4px;
    content: '';
    display: block;
    position: absolute;
  ...
  #archivedCards .info>.users .avatar {
    display: inline-block;
    position: relative;
    border-radius: 50%;
    top: -5px;
  ...
  #archivedCards .cardName {
    word-wrap: break-word;
  }

  #archivedCards .card-item .red {
    background-color: #b10b0b;
  }

  #archivedCards .card-item .yellow {
    background-color: #cfa227;
  }

  #archivedCards .card-item .green {
    background-color: #2a5f29;
  }

  #archivedCards .card-item .green-name .cardName {
    color: #2a5f29 !important;
  }
  ...
  #archivedCards .card-item .has-color .info>.label-light {
    color: #FFFFFF;
  }
