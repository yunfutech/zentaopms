...
<style>
  ...
  .kanbanTree .kanbans>ul>li label {
  ...
  .kanbanTree li a i.icon {
    font-size: 15px !important;
  }

  .kanbanTree li a i.icon:before {
  ...
  .kanbanTree .tree li>.list-toggle {
    line-height: 24px;
  }

  .kanbanTree .tree li.has-list.open:before {
    content: unset;
  }
    ...
    <div class='list-group'>
      ...
      <?php if ($myKanbans) : ?>
        <ul class="nav nav-tabs  nav-tabs-primary" id="navTabs">
          <li class="<?php if ($tabActive == 'myKanban') echo 'active'; ?>"><?php echo html::a('#myKanban', $lang->kanban->my, '', "data-toggle='tab' class='not-list-item not-clear-menu'"); ?><span class="label label-light label-badge"><?php echo $myKanbans; ?></span>
          <li>
          <li class="<?php if ($tabActive == 'other') echo 'active'; ?>"><?php echo html::a('#other', $lang->kanban->other, '', "data-toggle='tab' class='not-list-item not-clear-menu'") ?><span class="label label-light label-badge"><?php echo $others; ?></span>
          <li>
        </ul>
      <?php endif; ?>
