<style>
  ...
  #cards .project-detail>p {
    margin-bottom: 8px;
  }

  #cards .project-detail .progress {
    height: 4px;
  }

  #cards .project-detail .progress-text-left .progress-text {
    width: 50px;
    left: -50px;
  }
  ...
  #cards .project-stages-container {
    margin: 0 0 -16px 0;
    padding: 0 4px;
    height: 46px;
    overflow-x: auto;
  ...
  #cards .project-stages-row {
    position: relative;
    height: 30px;
    z-index: 0;
  }

  #cards .project-stage-item {
    white-space: nowrap;
    position: absolute;
    top: 0;
    min-width: 48px;
  ...
  #cards .project-stage-item:before {
    content: ' ';
    display: block;
    width: 8px;
    height: 8px;
  ...
  #cards .project-stage-item+.project-stage-item:after {
    content: ' ';
    display: block;
    left: -50%;
    right: 50%;
  ...
  #cards .project-stage-item.is-going {
    color: #333;
  }

  #cards .project-stage-item.is-going::before {
    background-color: #0C64EB;
  }

  #dashboard .block-recentproject .panel-body {
    padding: 0;
  }
