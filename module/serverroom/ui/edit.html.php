...
formPanel(set::id('serverroomCreateForm'), set::title($lang->serverroom->edit), formRow
(
    formGroup(set::width('600px'), set::name('name'), set::label($lang->serverroom->name), set::value($serverRoom->name))
), formRow
(
    formGroup(set::width('600px'), set::name('bandwidth'), set::label($lang->serverroom->bandwidth), set::value($serverRoom->bandwidth))
), formRow
(
    formGroup
    (
