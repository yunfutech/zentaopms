      ...
      <table class='table table-form'>
        <?php if ($config->systemMode == 'new') : ?>
          <tr>
            ...
            <td><?php echo html::select('project', $allProjects, $execution->project, "class='form-control chosen' required"); ?></td>
            <td></td>
          </tr>
        <?php endif; ?>
        <tr>
          <th class='w-120px'><?php echo $lang->execution->name; ?></th>
          <td><?php echo html::input('name', $execution->name, "class='form-control' required"); ?></td>
          <td></td>
        </tr>
        <tr>
            ...
            <div class='row'>
              ...
              <?php foreach ($linkedProducts as $product) : ?>
                ...
                <?php foreach ($linkedBranches[$product->id] as $branchID => $branch) : ?>
                  <div class='col-sm-4'>
                    <div class="input-group<?php if (in_array($project->model, array('kanban', 'waterfall')) and $i == 0) echo " required";
                                            if ($hasBranch) echo ' has-branch'; ?>">
