...
<style>
  .btn-group a i.icon-plus,
  .btn-group a i.icon-link {
    font-size: 16px;
  }
  ...
  .btn-group button.dropdown-toggle.btn-secondary,
  .btn-group button.dropdown-toggle.btn-primary {
    padding: 6px;
  }
</style>
          ...
          <table class='table table-form'>
            ...
            <?php if ($lang->hourCommon !== $lang->workingHour) : ?>
              <tr>
                ...
                <td>
                  <div class='input-group'><span class='input-group-addon'><?php echo "="; ?></span><?php echo html::input('hourPointValue', '', "class='form-control' required"); ?> <span class='input-group-addon'><?php echo $lang->workingHour; ?></span></div>
                </td>
                <td></td>
              </tr>
            <?php endif; ?>
            ...
            <tr>
              <td colspan='3'>
                <div class='alert alert-info no-margin'><?php echo $lang->story->batchToTaskTips ?></div>
              </td>
            </tr>
            <tr>
