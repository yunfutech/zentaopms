...
<div id="mainContent" class="main-content">
  ...
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->target->editRecord;?></h2>
    </div>
      ...
      <table class="table table-form">
        <tbody>
          ...
          <tr>
            <th>方案</th>
            <td colspan='5'>
              <?php echo html::textarea('solution', $record->solution, "style='height: 300px;' class='form-control kindeditor disabled-ie-placeholder' hidefocus='true' required");?>
            </td>
          </tr>
        </tbody>
        <tfoot>
