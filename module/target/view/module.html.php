      ...
      <table class="table table-form">
        <tbody>
          ...
          <tr>
            <th>类别</th>
            <td>
              <?php echo html::select("category", $category_names, $category_ids, "class='form-control chosen'");?>
            </td>
          </tr>
          <tr>
            <th>数据集</th>
            <td>
              <?php echo html::select("dataset", $dataset_names, $dataset_ids, "class='form-control chosen'");?>
            </td>
          </tr>
          <tr>
            <th>日期</th>
