    ...
    <form class='load-indicator main-form form-ajax' method='post' enctype='multipart/form-data' id='dataform'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td><?php echo html::select('isContract', $lang->milestone->isContractList, '0', "class='form-control chosen' onChange=changeContract(this.value)");?></td>
        ...
        <tr>
          ...
          <td><?php echo html::select('completed', $lang->milestone->completedList, '0', "class='form-control chosen'");?></td><td></td>
        </tr>
        <tr>
          <th><?php echo $lang->milestone->comment;?></th>
          <td colspan='3'>
            <div class='comment'><?php echo html::textarea('comment', '', "style='width:100%;height:200px'");?></div>
          </td>
        </tr>
        <tr>
