...
$config->project->create->requiredFields = 'name,code,begin,end,PO,PM';
$config->project->edit->requiredFields   = 'name,code,begin,end,PO,PM';

$config->project->customBatchEditFields = 'days,type,teamname,status,desc,PO,QD,PM,RD,pri';

$config->project->custom = new stdclass();
$config->project->custom->batchEditFields = 'days,status,PM,pri';
