...
?>
<style>
  .project-type-label.label-outline {
    width: 50px;
    min-width: 50px;
  }

  .project-type-label.label {
    overflow: unset !important;
    text-overflow: unset !important;
    white-space: unset !important;
  }

  #projectTableList .project-name {
    position: relative;
    display: flex;
    align-items: center;
  }
  ...
  #projectTableList .project-name>a {
    color: #0c60e1;
  ...
  #projectTableList .project-name.has-suffix>a {
