...
function locationPage(params)
{
    ...
    var link = createLink('pivot', 'preview', 'dimension=' + dimension + '&group=' + groupID + '&module=pivot&method=workassignsummary&params=' + paramsBtoa);
    location.href = link;
}
...
function workAssignSummaryPager(obj)
{
