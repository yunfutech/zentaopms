...
--
ALTER TABLE `zt_target_experiment`
  ADD CONSTRAINT `dataset` FOREIGN KEY (`did`) REFERENCES `zt_target_dataset` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
